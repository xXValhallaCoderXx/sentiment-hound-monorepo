...
const TryProductSection = () => {
  return (
    <Box display="flex" justifyContent="center" backgroundColor="#333A47">
      <Container maxW={"3xl"}>
        <Card colorScheme="primary" mt={10} mb={10} p={6}>
          <Flex>
            <Box>
              <Heading>Interested to try out product?</Heading>
              <Text color="gray.500">
                Sentiment Hound is currently in closed beta. If you are
                interested in trying out our product, please fill out the form
